...
def execute(filters=None):
	...
	for ss in salary_slips:
		row = {
			...
			"branch": ss.branch,
			"employment_type": ss.custom_employment_type,
			"employment_sub_type" : ss.custom_employment_sub_type,
			"employee_grade" : ss.custom_employee_grade,
...
def get_salary_slips(filters, company_currency):
	...
	if filters.get("employment_type"):
		query = query.where(salary_slip.custom_employment_type == filters.get("employment_type"))
	
	if filters.get("employment_sub_type"):
		query = query.where(salary_slip.custom_employment_sub_type == filters.get("employment_sub_type"))

	if filters.get("employee_grade"):
		query = query.where(salary_slip.custom_employee_grade == filters.get("employee_grade"))
