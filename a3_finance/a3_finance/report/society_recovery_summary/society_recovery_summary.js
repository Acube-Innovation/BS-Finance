...
frappe.query_reports["Society Recovery Summary"] = {

	onload: function (report) {

		// ---- PRINT BUTTON (ECR STYLE) ----
		report.page.add_inner_button("Print Report", function () {
			print_society_recovery_report(report);
		});
...
async function print_society_recovery_report(report) {

	let html = await frappe.query_reports["Society Recovery Summary"]
